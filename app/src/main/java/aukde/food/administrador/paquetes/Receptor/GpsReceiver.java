package aukde.food.administrador.paquetes.Receptor;
...
//import aukde.food.administrador.paquetes.Menus.MenuAukdeliver;
        ...
        if (locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            ...
            builder.setNegativeButton("Reintentar", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent i = new Intent();
                    i.setClassName("aukde.food.administrador", "aukde.food.administrador.paquetes.Menus.MenuAukdeliver");
