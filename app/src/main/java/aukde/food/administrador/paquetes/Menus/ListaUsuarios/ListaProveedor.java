...
import aukde.food.administrador.paquetes.Adaptadores.AdapterListaPorProveedor;
...
public class ListaProveedor extends AppCompatActivity {
    ...
    ArrayList<aukde.food.administrador.paquetes.Modelos.ListaProveedor> listUsuariosProveedor;
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()){
                        ...
                        for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                            aukde.food.administrador.paquetes.Modelos.ListaProveedor pd = snapshot.getValue(aukde.food.administrador.paquetes.Modelos.ListaProveedor.class);
    ...
    private void buscar(String texto) {
        ArrayList<aukde.food.administrador.paquetes.Modelos.ListaProveedor> lista = new ArrayList<>();
        for(aukde.food.administrador.paquetes.Modelos.ListaProveedor object : listUsuariosProveedor){
