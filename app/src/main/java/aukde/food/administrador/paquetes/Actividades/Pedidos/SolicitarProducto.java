...
import aukde.food.administrador.paquetes.Modelos.SpinnerProduct;
...
public class SolicitarProducto extends AppCompatActivity {
    ...
    private void obtenerProveedor() {
        final List<aukde.food.administrador.paquetes.Modelos.Spinner> proveedor = new ArrayList<>();
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot ds : dataSnapshot.getChildren()) {
                        ...
                        proveedor.add(new aukde.food.administrador.paquetes.Modelos.Spinner(id, nombres));
                    }
