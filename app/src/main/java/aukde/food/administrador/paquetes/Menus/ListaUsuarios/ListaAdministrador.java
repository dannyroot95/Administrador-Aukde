package aukde.food.administrador.paquetes.Menus.ListaUsuarios;
...
import aukde.food.administrador.paquetes.Adaptadores.AdapterListaPorAdministrador;
...
public class ListaAdministrador extends AppCompatActivity {
    ...
    ArrayList<aukde.food.administrador.paquetes.Modelos.ListaAdministrador> listAdministrador;
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()){
                        ...
                        for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                            aukde.food.administrador.paquetes.Modelos.ListaAdministrador pd = snapshot.getValue(aukde.food.administrador.paquetes.Modelos.ListaAdministrador.class);
    ...
    private void buscar(String texto) {
        ArrayList<aukde.food.administrador.paquetes.Modelos.ListaAdministrador> lista = new ArrayList<>();
        for(aukde.food.administrador.paquetes.Modelos.ListaAdministrador object : listAdministrador){
